...
def main():
    ...
    Wanneer je een waarde van 1000 invult bij Sessie komen alle URLs met minder dan 1000 sessie in aanmerking voor verwijderen (als alle overige metrics ook kloppen)")
