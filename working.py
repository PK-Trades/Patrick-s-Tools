...
def main():
    ...
    multi = "Hier onder kun je aangeven waar je post MINIMAAL aan moet voldoen om NIET in aanmerking te komen voor verwijdering.  Wanneer je een waarde van 1000 invult bij Sessie komen alle URLs met minder dan 1000 sessie in aanmerking voor verwijderen (als alle overige metrics ook kloppen)")
